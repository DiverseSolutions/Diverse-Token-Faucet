  ...
  return (
    <div className="w-full bg-base-100">
      <div className="md:px-4 navbar">
        ...
        <div className="justify-center flex-1 md:flex-none">
          <ul className="p-0 menu menu-horizontal">
            <li className="hidden mx-2 md:block">
              <a className="text-2xl md:block btn btn-link" href="https://github.com/DiverseSolutions">
                <svg width="1.03em" height="1em" viewBox="0 0 256 250"><path
                  fill="#161614"
