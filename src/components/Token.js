        ...
        <div className="card card-side">
          ...
          <div className="card-body">
            ...
            <div className="justify-end card-actions">
              <a className="btn btn-info btn-outline" target="_blank" href={`https://metamask.dsolutions.mn/add-token?name=${data.name}&symbol=${data.symbol}&decimals=${data.decimals}&address=${data.address}&imgUrl=${data.logoURI}`}>
