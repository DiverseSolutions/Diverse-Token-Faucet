...
import { fetchMetamaskAccounts } from '../../slices/metamaskSlice.js';
...
export default function Account(){
  ...
  const account = useMemo(() => {
    return metamask.account != null
      ? metamask.account.substring(0, 8) + "..."
      : "No Account";
  }, [metamask.account]);
